						...
						<div className="col">
							<div className="box">
								<p className={styles.paragraph}>
									...
									Volutpat integer dictum curabitur elementum.
									Orci senectus posuere id sed vulputate ipsum
									molestie sit adipiscing. Facilisis arcu et
									quis odio sit.
								</p>
							</div>
						</div>
						...
						<div className="col-xs-12 col-md-6">
							<div className="box">
								<div className="row">
									<div className="col-xs-12 col-md-6">
										<div
											className={`box ${styles.boxSeparator}`}
										>
											<SalesInfoCard
									...
									<div className="col-xs-12">
										<div className="box">
											...
											<p className={styles.paragraph}>
												...
												consectetur. Volutpat integer
												dictum curabitur elementum. Orci
												senectus posuere id
											</p>
										</div>
									</div>
